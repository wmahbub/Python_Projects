...
url_last_sale = ['https://stockx.com/api/products/5f212cfa-1910-4d01-b254-fabf09dded14/activity?state=480&currency=USD&limit=10&page=5&sort=createdAt&order=DESC&country=US',
...
r = requests.get(url_last_sale[2], headers=header)
...
print()
print(df_last_sale[['shoeSize', 'amount', 'localAmount', 'localCurrency']].head(10))
